...
#part 1 has 38 Nreps and dopes trial 1 t/m 228
...
exp_info = {'Participant number': rand_nr, 'Session': '1', 'Age': '', 'Gender': ["Female", "Male", "X"]}
...
welcome_txt = TextStim(win, text="""Welcome to this experiment!
...
#screen with thanks
mouse.setPos(newPos=muisPos) #muis buiten beeld
bye_txt = TextStim(win, text="""You are now on a quarter. 
Please call the researcher to start the second part. 
