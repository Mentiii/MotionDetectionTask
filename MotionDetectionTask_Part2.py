...
# part 2 has 38 Nreps and does trial 229 t/m 456
...
exp_info = {'Participant number': rand_nr, 'Session': '2', 'Age': '', 'Gender': ["Female", "Male", "X"]}
...
#screen with thanks
mouse.setPos(newPos=muisPos) #muis buiten beeld
bye_txt = TextStim(win, text="""You are now on halfway past! 
Please enjoy a well deserved break. 

You can call the researcher if you are ready to continue or if you want some company :)
