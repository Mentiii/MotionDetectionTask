...
#part 3 has 38 Nreps and covers trial 457 t/m 684
...
exp_info = {'Participant number': rand_nr, 'Session': '3', 'Age': '', 'Gender': ["Female", "Male", "X"]}
...
#screen with thanks
mouse.setPos(newPos=muisPos) #muis buiten beeld
bye_txt = TextStim(win, text="""You are now on three quarters! 

Please call the researcher to start the final part. 
